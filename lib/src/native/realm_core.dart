...
class _RealmCore {
  ...
  AppHandle getApp(ApplicationConfiguration configuration) {
    ...
    return AppHandle._(
      _realmLib.realm_app_get(appConfig._pointer, syncClientConfig._pointer),
      syncClientConfig,
      httpTransport,
    );
  }
  ...
  Future<UserHandle> logIn(Application application, Credentials credentials) async {
    ...
    _realmLib.realm_app_log_in_with_credentials(
      ...
      _realmLib.gc_handle_new(completer),
      nullptr,
    );
...
class AppHandle extends Handle<realm_app> {
  final SyncClientConfigHandle syncClientConfigHandle;
  final RealmHttpTransportHandle httpTransportHandle;
  AppHandle._(
    Pointer<realm_app> pointer,
    this.syncClientConfigHandle,
    this.httpTransportHandle,
